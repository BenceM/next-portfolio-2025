...
export default function ProjectFilterPills({ value, handleSelect, label }) {
	return (
		<button
			className={`px-6 py-1 transition-all ease-in-out duration-300 bg-background relative flex items-center justify-center hover:bg-bgHover hover:shadow-xl rounded-full after:h-[108%] after:w-[103%] after:absolute after:bg-gradient-to-br after:from-gradientMain after:via-gradientVia  after:to-gradientTo after:rounded-full after:-z-10 group `}
